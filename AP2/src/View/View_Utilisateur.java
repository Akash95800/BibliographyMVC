...
public class View_Utilisateur {
	 ...
	 */
	public View_Utilisateur() throws ClassNotFoundException, SQLException {
		MainMVC.getM().getAll();
		initialize();
	...
	private void initialize() {
		...
		btnNewButton_MAJ.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					lblNewLabel_info.setText("Info Mis � jour");
					MainMVC.getM().getAll();
		...
		lblNewLabel_5.setIcon(new ImageIcon("/Users/akashroubert/Downloads/biblio.png"));
		lblNewLabel_5.setBounds(0, -4, 481, 421);
